...
export function ResetPasswordPage() {
  ...
  const handleReset = (e: React.FormEvent) => {
    e.preventDefault();
    // Simulate password change and redirect to success page
      ...
      <div className="flex w-full max-w-[1000px] min-h-[600px] bg-white rounded-[32px] shadow-2xl overflow-hidden">
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 lg:p-16 bg-white">
          <div className="w-full max-w-sm">
            <div className="mb-8">
              <h1 className="text-[28px] font-bold text-slate-900 tracking-tight mb-2">Reset Password?</h1>
            ...
            <form onSubmit={handleReset} className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-sm font-semibold text-slate-800">Old Password</label>
              ...
              <div className="space-y-1.5">
                <label className="text-sm font-semibold text-slate-800">New Confirm Password</label>
                <div className="relative">
                  <input
              ...
              <button
                type="submit"
                className="w-full py-2.5 px-4 bg-[#1E847C] hover:bg-[#156a63] text-white font-medium rounded-lg shadow-sm transition-all focus:outline-none focus:ring-2 focus:ring-[#1E847C]/50 focus:ring-offset-2 mt-2"
              >
                Change Password
              </button>
            </form>
            ...
            <div className="mt-8 text-center text-sm">
              ...
              <Link to="/" className="font-semibold text-[#2563EB] hover:text-blue-700 hover:underline">
                Log in
              </Link>
            </div>
          </div>
