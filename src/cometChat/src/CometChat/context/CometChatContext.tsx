...
import { COMET_CHAT_RUNTIME_INFO } from '../../../integration-metadata';
...
// This keeps the embedded CometChat bundle identifiable without depending on the
// original standalone sample app's package.json.
...
if (typeof window !== 'undefined') {
  window.CometChatVisualBuilderReact = {
    name: COMET_CHAT_RUNTIME_INFO.name,
    version: COMET_CHAT_RUNTIME_INFO.version,
  };
}
