    ...
    <div className="faculty-panel rounded-lg p-4">
      <DateCalendar
        ...
        classNames={{
          ...
          month: 'w-full',
          month_caption:
            'faculty-panel-subtle mb-4 flex items-center justify-between rounded-lg p-2',
          ...
          selected:
            '[&>button]:bg-primary [&>button]:font-medium [&>button]:text-primary-foreground [&>button]:shadow-sm [&>button]:hover:bg-primary [&>button]:hover:text-primary-foreground',
